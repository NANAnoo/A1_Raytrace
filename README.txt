...
./RaytraceRenderWindow ../path_to/model.obj ../path_to/texture.mtl

---------------------------------------------

To run on OSX:
./RaytraceRenderWindow.app/Contents/MacOS/RaytraceRenderWindow  ../path_to/model.obj ../path_to/texture.mtl

---------------------------------------------
To run on Windows
./RaytraceRenderWindow.exe ../path_to/model.obj ../path_to/texture.mtl
or
Click projects
Select "Run" on the left side menu under the active configuration
Add "../path_to/model.obj ../path_to/texture.mtl" to command line arguments
